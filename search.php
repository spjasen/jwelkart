...
<div class="container ">
 ...
 <div class="w3-row w3-padding-16">
  ...
  <div class="w3-center"><input type = "text" class="w3-input w3-border" name="ser" required><br>
      <input class="w3-btn w3-indigo w3-large w3-animate-bottom" type = "submit" name="search">
...
{
  $ser=$_GET['ser'];
    $sql = "SELECT * FROM collection WHERE pro_name LIKE '%". $ser."%'";
