...
if (isset( $_GET['checkboxvar']))
{
    ...
    foreach($_GET['checkboxvar'] as $user)
{
   $sql = "SELECT * FROM collection WHERE pro_id ='$user' ";
...
<div class = ' w3-center'><a href='detail.php?pro_id=$pro_id'><img class='w3-border w3-card-2'  src='admin_area/product_img/$pro_img' style='width:100%;height:300px;' ></a></div>
  <br>
